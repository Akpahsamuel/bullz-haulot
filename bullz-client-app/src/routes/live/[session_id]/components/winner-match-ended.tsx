...
const WinnerMatchEnded = (props: Props) => {
  ...
  const formatPrize = (amount: number) => {
    return (amount / 1_000_000_000).toFixed(2); // Convert MIST to SUI
  };
  ...
  const opponentAddress = props.matchData?.loser || "Unknown";
              ...
              <div>
                ...
                >
                  ...
                  <span className="font-[700] block text-white text-[1.375rem]">
                    {props.matchData?.prizeAmount ? formatPrize(props.matchData.prizeAmount) : '0'}
                  </span>
                </div>
