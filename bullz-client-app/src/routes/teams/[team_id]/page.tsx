...
import Pitch from "@/routes/squad.old/components/pitch";
import SquadItem from "@/routes/squad.old/components/squad-item";
  ...
  return (
    <>
      ...
      <Pitch
        ...
        onPlayerClick={() => {
          // Player interaction handled here
        }}
        ctaLabel=""
      />
          ...
          <div className="flex items-center gap-[0.5rem] w-min overflow-x-scroll ">
            {[1, 2, 3].map((squad) => (
              <SquadItem
                key={squad}
                onClick={() => {
                  // Squad interaction handled here
                }}
